...
- [x] T006: Create TipTap-based SpecRenderer with Node View extensions (depends: T002, T005)
...
- [x] T007: Validate markdown round-trip hash fidelity (depends: T006)
...
- [x] T008: Implement Edit/View mode toggle with anchor write-back (depends: T007)
...
- [x] T009: Adapt SelectionPopover and BlockRangeSelector for TipTap (depends: T006)
...
- [x] T010: Create InlineThread component (depends: T006)
...
- [x] T011: Wire InlineThread into Node Views (depends: T010, T009)
...
- [x] T012: Create ThreadNav component replacing RightPanel (depends: T001)
...
- [x] T013: Wire ThreadNav into SpecReviewPage with scroll targeting (depends: T012, T011)
...
- [x] T014: Redesign SpecOutline with search and Notion styling (depends: T001)
...
- [x] T015: Restyle ComposeBox for dark Notion theme (depends: T001)
...
- [x] T016: Delete AnnotationGutter and RightPanel (depends: T013)
...
- [x] T017: Final SpecReviewPage layout assembly (depends: T016, T014, T008, T004)
...
- [x] T018: Visual verification and polish (depends: T017)
