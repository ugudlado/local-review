...
export default function Dashboard() {
  ...
  const { sortedFeatures, searchCount } = useMemo(() => {
    ...
    return { sortedFeatures: combined, searchCount: count };
          ...
          <div className="flex flex-1 items-center gap-2">
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full rounded-md bg-[var(--bg-base)] py-1.5 pl-8 pr-16 text-sm text-slate-200 placeholder-slate-600 ring-1 ring-[var(--border-default)] transition-all focus:outline-none focus:ring-[var(--accent-blue)]"
              />
              {searchCount && (
