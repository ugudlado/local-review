...
export function createTasksRoute(repoRoot) {
    const app = new Hono();
    ...
    app.get("/:id/tasks", async (c) => {
        ...
        const tasksFilePath = wtPath
            ...
            : path.join(repoRoot, "specs", "archived", featureId, featureId, "tasks.md");
        let tasksContent;
        try {
    ...
    app.put("/:id/tasks", async (c) => {
        ...
        const tasksFilePath = path.join(wtPath, "specs", "active", featureId, "tasks.md");
